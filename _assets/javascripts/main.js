...
function register($form) {
    $.ajax({
        ...
        url: '/email_collect',
        data: { 
          'email-submit-field': $('input#email-submit-field').val()
        }
    });
    $('input#email-submit-field').val('');
}